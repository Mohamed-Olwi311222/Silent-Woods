...
public class BacteriaBehaviour : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //states
        IdleState idleState = new IdleState(bacteriaEntity);
        PatrolState patrolState = new PatrolState(bacteriaEntity, playerRef.transform.position, patrolPoints);
        AggressiveState aggressiveState = new AggressiveState(bacteriaEntity, playerRef.transform);
